...
<body>
    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col">
                <a class="btn btn-primary btn-input" href="{{ route('admin.tambahdosen') }}">TAMBAH DATA</a>
            </div>
            <div class="col">
                <form action="{{ route('admin.dosen') }}" method="GET">
                    @csrf
                    <div class="input-group mt-3">
                        <input type="search" name="search" class="form-control rounded" placeholder="Cari nama dosen"
        ...
        <table class="table table-primary table-striped" style="margin-top: 10px">
            ...
            <tbody class="table-group-divider">
                ...
                <tr>
                    ...
                    <td><img style="width: 50px" src="{{ asset('/images/' . $dosen->gambar) }}" alt="gambar"></td>
                    ...
                    <td>{{ $dosen->no_hp }}</td>
                    <td>
    <a class="btn btn-primary" href="/admin/editdosen/{{ $dosen->id }}">Edit</a>
    <a class="btn btn-primary" href="/admin/deletedosen/{{ $dosen->id }}">Delete</a>
</td>
